...
def generate_launch_description():
    ...
    use_tb4_camera_arg = DeclareLaunchArgument(
        'use_tb4_camera',
        default_value='false',
        description='Use TurtleBot 4 OAK-D camera instead of RealSense'
    )

    use_tb4_camera = LaunchConfiguration('use_tb4_camera')
